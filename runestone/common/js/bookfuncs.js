...
function timedRefresh() {
    ...
    $(document).bind("idle.idleTimer", function() {
        ...
        if (location.href.indexOf("index.html") < 0) {
            ...
            location.href =
                eBookConfig.app + "/default/user/login?_next=" + location.pathname;
        }
    });
...
function notifyRunestoneComponents() {
    ...
    if (typeof $pjQ !== "undefined") $pjQ(document).trigger("runestone:login-complete"); // for parsons components which are using a different version of jQuery
}
